...
<li><img src="images/fullscreen.png" width='20' alt=''> <b>Fullscreen</b>: enter full screen mode.</li><li><img src="images/exit_fullscreen.png" width='20' alt=''> <b>Exit fullscreen</b>: exit full screen mode.</li></ul>  </ul>
...
<p>Note that the Save keyboard shortcut (Ctrl-S) only works if the focus is on the editor text area and the text input caret blinks.
     Otherwise, the browser page will be saved instead of the file changes.</p> <h2>Interaction with objects and robots</h2>
  <p>An object context menu is displayed when
clicking with the right mouse button     on an object or robot in the 3D scene. The objects context menu provides the following actions:
   <ul>
...
clicking on it using the left mouse button.      Once selected, a white outline representing the physical shape of the object is displayed.
...
set the mouse pointer in the 3D scene, press the left mouse button, and drag the mouse:     <ul>
...
set the mouse pointer in the 3D scene, press the right mouse button, and drag them mouse.    </p>
...
<h4>Zoom</h4><p>To zoom in or out the 3D scene, set the mouse pointer in the 3D scene and use the wheel of the mouse.</p>   <h4>Zoom/Tilt</h4>
   <p>
To zoom and tilt the camera, you have to set the mouse pointer in the 3D scene and press both left and right mouse buttons (or the middle button):<ul><li>If you drag the mouse vertically, the camera will zoom in or out.</li><li>If you drag the mouse horizontally, the camera will rotate around its <em>z</em> axis (tilt movement).</li></ul>    </p>
    <p>The zoom speed is proportional to the distance from the viewpoint to the 3D point on which you clicked
(or on which the mouse pointer was located when you used the mouse wheel)      . If you click on the background
(or have the mouse pointer over the background while using the mouse wheel)      , the translation speed is proportional to the distance to origin of the world, e.g., (0, 0, 0).</p>
