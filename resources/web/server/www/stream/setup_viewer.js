...
if (mobileDevice) {
  ...
  mobileCss.setAttribute('href', '/R2019b/wwi_mobile.css');
...
function connect() {
  ...
  view.open('ws://' + ipInput.value + ':' + portInput.value + '/samples/robotbenchmark/pick_and_place/worlds/pick_and_place.wbt');
